...
<style>
  * { margin: 0; padding: 0; box-sizing: border-box; }
  ...
  #pdf-canvas {
    ...
    background: #fff;
    /* Bù lại hiện tượng chữ bị nhạt/xám do anti-aliasing khi canvas
       được vẽ độ phân giải cao rồi thu nhỏ bằng CSS */
...
// Ép tối thiểu 2x để supersample nhiều hơn -> chữ nét/đậm hơn, đỡ bị mờ xám
// khi canvas bị thu nhỏ bằng CSS. Có thể tăng lên 2.5 - 3 nếu máy đủ mạnh.
